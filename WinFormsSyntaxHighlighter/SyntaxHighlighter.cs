...
namespace WinFormsSyntaxHighlighter
{
    public class SyntaxHighlighter
    {
        ...
        private readonly FastColoredTextBox _richTextBox2;
        ...
        public SyntaxHighlighter(FastColoredTextBoxNS.FastColoredTextBox richTextBox)
        {
            if (richTextBox == null)
                throw new ArgumentNullException("richTextBox");
            ...
            _fontSizeFactor = Convert.ToInt32(_richTextBox2.Font.Size * 2);
            _fontName = _richTextBox2.Font.Name;

            DisableHighlighting = false;

            _richTextBox2.TextChanged += RichTextBox_TextChanged;
        }
